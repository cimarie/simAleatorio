...
for b in "0.0" "1.0" "2.0" "5.0"; do
    for alpha in "0.2" "0.8" "1.0"; do 
        ...
        python workflow_teste.py RodaTodosTestes --local-scheduler --benefit $b --alpha $alpha --nindiv 26 --ngroup 5000 --mu 0.0001 --delta $delta > resflow_b=${b}.alpha=${alpha}.txt
